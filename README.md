...
As outlined in https://github.com/sfg-autonomous-systems/sfg_docs/blob/main/docs/access_and_security_policy.md, the branch named `main` is protected across all repositories in this organization. To allow the GitHub App to commit new packages, you must explicitly allow it to bypass branch protection:
